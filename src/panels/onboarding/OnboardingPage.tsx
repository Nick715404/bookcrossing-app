...
export const OnboardingPage = ({ page, onNext, onPrev, onMenu }: Props) => {
		...
		<Group id={page.id}>
			<Group style={{ height: '85dvh' }} className='onboarding__wrapper'>
				<Div className='onboarding__content'>
					...
					<Text className='onboarding__description'>{page.text}</Text>
					<Div className='nav-buttons-box'>
						<IconButton
							disabled={page.id === '1' && true}
							onClick={onPrev}
