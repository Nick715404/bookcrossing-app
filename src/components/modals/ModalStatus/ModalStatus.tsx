			...
			<Div className='statusBookPage'>
				<Group separator='hide'>
					...
					<Div>
						...
						<Text className='text' style={{ marginBottom: 16 }}>
							Допускаются царапины
						</Text>
					</Div>
				</Group>
				...
				<Group separator='hide'>
					...
					<Div>
						<Text className='text'>
							Обложка незначительно повреждена, или потерта
						</Text>
						<Text className='text'>
							На станицах незначительные пометки или помарки
						</Text>
						<Text className='text'>Страницы не порваны</Text>
						<Text className='text'>
							Книга может быть покороблена от воздействия влаги
						</Text>
						<Text className='text' style={{ marginBottom: 16 }}>
							Суперобложка (если была) порвана или утеряна
						</Text>
					</Div>
				</Group>
				...
				<Group separator='hide'>
					...
					<Div>
						<Text className='text'>
							Страницы содержат значительные пометки или помарки
						</Text>
						<Text className='text'>
							Обложка повреждена, но не потеряна целиком
						</Text>
						<Text className='text'>
							Некоторые страницы порваны, испачканы, но текст читается
							полностью, ни одна страница не утеряна
						</Text>
						<Text className='text' style={{ marginBottom: 16 }}>
							Переплет может частично распадаться на тетради, некоторые страницы
							могут выпадать
						</Text>
					</Div>
				</Group>
				...
				<Group separator='hide'>
					...
					<Div className='bottomStatus'>
						...
						<Text className='text'>
							Страницы повреждены либо испачканы, что существенно мешает
							восприятию текста
						</Text>
