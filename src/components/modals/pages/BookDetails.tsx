...
import { Div, Group, Text, Separator, CellButton } from '@vkontakte/vkui';
...
const BookDetails = ({
	...
	return (
		<Div>
			...
			>
				<Text className='bookText'>Состояние: {book.state}</Text>
				<CellButton
					className='bookInfo'
			...
			<Text className='bookText'>
				...
				<br /> {book.description ? book.description : 'Описание не указано'}
			</Text>
			<Text className='bookText'>
